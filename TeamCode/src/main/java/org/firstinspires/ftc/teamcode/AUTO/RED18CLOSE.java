...
@Autonomous
public class RED18CLOSE extends CommandOpMode {
    ...
    public void buildpath(){
        Path1 = follower.pathBuilder().addPath(
                        new BezierLine(
                                new Pose(22.364, 118.172).mirror(),
        ...
        Path14 = follower.pathBuilder().addPath(
                        new BezierLine(
                                new Pose(23.000, 35.000).mirror(),
                                new Pose(58.000, 106.000).mirror()
                        )
                ).setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
    }
    ...
    public void initialize() {
        ...
        follower.setStartingPose(new Pose(22.364, 118.172, Math.toRadians(180)).mirror());
        buildpath();
